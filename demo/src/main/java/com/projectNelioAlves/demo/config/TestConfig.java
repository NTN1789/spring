package com.projectNelioAlves.demo.config;

import com.projectNelioAlves.demo.Entities.*;
...
@Configuration
@Profile("test")        // tem que passar o que eu coloquei  no application
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        p1.getCategories().add(cat2);   // assosicao entre objetos
